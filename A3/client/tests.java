...
public class tests{
    ...
    public static void main(String[] args) {
        ...
        t.WrongUsername();t.AdvisorUsername();
    ...
    public void Student_SwapCOMPCourse() {
        System.out.println("-----------------------------");
        System.out.println("Testing with  => Student => SWAP Course => comp1234,Comp1111,fall");
        clientTest test = new clientTest("comps1357");
        test.swapCourse("comp1111","comp1234","fall");
        System.out.println("-----------------------------");
    }
    ...
    public void Student_RemoveCOMPCourse() {
        System.out.println("-----------------------------");
        System.out.println("Testing with  => Student => drop Course => comp1111");
        clientTest test = new clientTest("comps1357");
        test.dropCourse("comp1111");
        System.out.println("-----------------------------");
    }
